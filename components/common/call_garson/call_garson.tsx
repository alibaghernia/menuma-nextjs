...
export const CallGarson: ICallGarson = ({
  onClick,
  isCancel,
  size: buttonSize,
}) => {
  ...
  return (
    <div
      className={classNames(
        ...
        {
          'text-typography active:text-more border-more bg-more/[.1] active:bg-more/[.2]':
            !isCancel,
          'border-red-600 bg-red/[.1] active:bg-red-600/[.2] text-red-600':
            isCancel,
        },
      )}
      onClick={onClick}
    >
      {isCancel ? 'لغو درخواست گارسون' : 'درخواست گارسون'}
    </div>
  );
};
