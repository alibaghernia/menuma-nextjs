...
export const CategoryCard: ICategoryCard = (props) => {
  return (
    <div className={classNames("rounded-[.625rem] w-[8.7rem] h-[8.7rem] relative px-[3.3rem] py-[4.4rem] block overflow-hidden cursor-pointer", { "border-4": props.selected, "border-more": props.selected })} onClick={props.onClick}>
